                        ...
                        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                          <li>
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                <li >
                                      <a href="{{route('logout')}}" class="flex flex-col  pl-2 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-gray-800" >
                                        <div class="text-sm leading-5 font-medium text-white">
                                            <x-icon.active class="text-pink-600 cursor-pointer"  />
                                            {{ auth()->user()->firstname }}  {{ auth()->user()->lastname }}
                                        </div>
                                        <div class="pl-6">
                                            {{__('Logout')}}
