                ...
                <x-table.row>
                    <x-table.cell colspan="7">
                        <div class="flex justify-center items-center space-x-2">
                            ...
                            <span class="font-medium py-8 text-cool-gray-400 text-xl">{{__('No image found')}}...</span>
                        </div>
                    </x-table.cell>
                </x-table.row>
            @endforelse
...
@push('css')
  @vite(['node_modules/filepond/dist/filepond.min.css','node_modules/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css'])
@endpush
@push('scripts')
