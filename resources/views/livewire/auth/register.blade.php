          ...
          <div class="relative overflow-hidden bg-dark-blue py-10 px-6 sm:px-10 xl:p-12">
            ...
            <dl class="mt-8 space-y-6">
              ...
              <dd class="flex text-base text-indigo-50">
                ...
                <span class="ml-3"><a href="tel:+32 498.92.12.53">+32 498.92.12.53</a></span>
              </dd>
              ...
              <dd class="flex-col text-base text-indigo-50">
                ...
                <div class="ml-9">BE51 3630 3269 1262</div>
              </dd>
            </dl>
                ...
                x-data="{
                  ...
                  <div class="relative w-full">
                    ...
                    <ul 
                      ...
                      -->
                      <li wire:click="setSession(1)"  x-on:click.prevent="session = 'Bruxelles 28/04';toggle()" class="text-gray-900 cursor-default select-none p-4 text-sm" id="listbox-option-0" role="option">
                        <div class="flex flex-col">
                          <div class="flex justify-between"  >
                            <!-- Selected: "font-semibold", Not Selected: "font-normal" -->
                            <p class="font-normal text-xs">{{__('home.agendaContentPrefix1')}}: {{__('home.agendaWhen1')}}</p>
                            <!--
                      ...
                      <li wire:click="setSession(3)"  x-on:click.prevent="session = 'Liège 26/05';toggle()" class="text-gray-900 cursor-default select-none p-4 text-sm" id="listbox-option-0" role="option">
                        <div class="flex flex-col">
                          <div class="flex justify-between"  >
                            <!-- Selected: "font-semibold", Not Selected: "font-normal" -->
                            <p class="font-normal text-xs">{{__('home.agendaContentPrefix3')}}: {{__('home.agendaWhen3')}}</p>
                            <!--
                              Checkmark, only display for selected option.
                      ...
                      <li wire:click="setSession(4)"  x-on:click.prevent="session = 'Nivelles 09/06';toggle()" class="text-gray-900 cursor-default select-none p-4 text-sm" id="listbox-option-0" role="option">
                        <div class="flex flex-col">
                          <div class="flex justify-between"  >
                            <!-- Selected: "font-semibold", Not Selected: "font-normal" -->
                            <p class="font-normal text-xs">{{__('home.agendaContentPrefix4')}}: {{__('home.agendaWhen4')}}</p>
                            <!--
                              Checkmark, only display for selected option.
