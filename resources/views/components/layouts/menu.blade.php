      ...
      <div class="flex items-center justify-between border-b-2 border-gray-100 py-0 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="{{url('/').'/'.App::currentLocale().''}}">
            ...
            <img src="https://itcl.s3.eu-west-1.amazonaws.com/businesspadeltour/bpt-logo-arenal3.png" class="w-48 py-1 loaded" />
          </a>
        </div>
            ...
            <div x-show="isOpen"
              ...
              <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                  ...
                  <a href="https://itcl.s3.eu-west-1.amazonaws.com/businesspadeltour/doc/reglement-bpt-{{App::currentLocale() ?? 'fr'}}.pdf" x-on:click="isOpen=false" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                    <!-- Heroicon name: outline/squares-2x2 -->
                    ...
                    <div class="ml-4">
                      <p class="text-base font-medium text-gray-900">{{__('menu.rule')}}</p>
                    </div>
                  </a>
          ...
          <div class="mt-6">
            <nav class="grid gap-y-8">
              ...
              <a href="{{url('/').'/'.App::currentLocale().'/photos'}}" x-on:click="isMobileNavOpen=false" class="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
                ...
                <span class="ml-3 text-base font-medium text-gray-900">{{__('Photos')}}</span>
              </a>
              ...
              <a href="https://itcl.s3.eu-west-1.amazonaws.com/businesspadeltour/doc/reglement-bpt-{{App::currentLocale() ?? 'fr'}}.pdf" x-on:click="isMobileNavOpen=false" class="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
                <!-- Heroicon name: outline/arrow-path -->
                <svg class="h-6 w-6 flex-shrink-0 color-dark-blue" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.031.352 5.988 5.988 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 01-2.031.352 5.989 5.989 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971z"></path>
                </svg>
