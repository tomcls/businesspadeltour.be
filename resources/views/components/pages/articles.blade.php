        ...
        <div class="relative px-6 pt-16 pb-20 lg:px-8 lg:pt-36 lg:pb-28">
            ...
            <div class="relative mx-auto max-w-7xl">
              <div class="text-center">
                <h2 class="text-3xl font-bold tracking-tight color-dark-blue sm:text-4xl">{{__('news.title')}}</h2>
                <p class="mx-auto mt-3 max-w-2xl text-xl text-gray-500 sm:mt-4">{{__('news.teaser')}}</p>
              </div>
          ...
          <footer class="bg-white py-20 mt-0">
            <div class="bg-white " id="sponsor">
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                  <h2 class=" text-pretty text-5xl font-medium tracking-tight  sm:text-6xl color-dark-blue pb-7">{{__('An organization of')}}</h2>
                </div>
                <div class="flex flex-1 mt-10">
                  <ul role="list" class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center justify-center  sm:border-t sm:border-gray-200 sm:py-5   sm:space-x-12 ">
                    <li>
            ...
            <div class="bg-white pt-20" >
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                  <h2 class=" text-pretty text-5xl font-medium tracking-tight  sm:text-6xl color-dark-blue pb-7">{{__('In partnership with')}}</h2>
                </div>
                <div class="flex flex-1 mt-10">
            ...
            <div class="bg-white " id="sponsor">
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                  <h2 class=" text-pretty text-5xl font-medium tracking-tight  sm:text-6xl color-dark-blue pb-7">{{__('The clubs')}}</h2>
                </div>
                <div class="flex flex-1 mt-10">
