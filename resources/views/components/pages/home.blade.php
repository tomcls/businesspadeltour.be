      ...
      <div class="relative px-6 lg:px-8 z-0">
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6 mb-6">
            <img class=" " src="{{url('/').'/images/logo/logo.png'}}" alt="Business padel tour">
          </div>
          <div class="text-center">
            
            <h1 class="text-4xl font-bold tracking-tight color-dark-blue sm:text-6xl">Business padel tour</h1>
            <p class="mt-6 text-lg leading-8 text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="#" class="rounded-md bg-dark-blue px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Plus d'infos</a>
              <a href="#" class="text-base font-semibold leading-7 text-gray-900">Plus d'infos <span aria-hidden="true">→</span></a>
            </div>
          </div>
        </div>
          ...
          <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="lg:pr-8 lg:pt-4">
              <div class="lg:max-w-lg">
                <h2 class="text-lg font-semibold leading-8 tracking-tight color-light-blue">Le Business padel tour</h2>
                <p class="mt-2 text-3xl font-bold tracking-tight text-gray-300 sm:text-4xl">En résumé</p>
                <p class="mt-6 text-lg leading-8 text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
      ...
      <div class="overflow-hidden bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div class="lg:pr-8 lg:pt-4">
              <div class="lg:max-w-lg">
                <h2 class="text-lg font-semibold leading-8 tracking-tight color-light-blue">Le programme</h2>
                <p class="mt-2 text-3xl font-bold tracking-tight text-gray-300 sm:text-4xl">5 sessions et une finale</p>
                <p class="mt-6 text-lg leading-8 text-gray-900">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
      ...
      <div class="overflow-hidden bg-black py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="lg:pr-8 lg:pt-4">
              <div class="lg:max-w-lg">
                <h2 class="text-lg font-semibold leading-8 tracking-tight color-light-blue">Les clubs (étapes)</h2>
                <p class="mt-2 text-3xl font-bold tracking-tight text-gray-300 sm:text-4xl">5 clubs répartis dans toute la Belgique</p>
                <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-white lg:max-w-none">
                  <div class="relative pl-9">
                    <dt class="inline font-semibold text-gray-400">
                      <!-- Heroicon name: mini/cloud-arrow-up -->
      ...
      <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Les dates et lieux des 5 sessions</p>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              <div class="relative pl-16">
                ...
                <dd class="mt-2 text-base leading-7 text-gray-600">
                  <b>Quand: </b> Vendredi 5 avril 2023 à partir de 13.00<br/>
                  <b>Lieu: </b> Chaussée de Carleroi 224, 1060 Bruxelles<br/><br/>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div class="p-8 sm:p-10 lg:flex-auto">
              <h3 class="text-2xl font-bold tracking-tight text-gray-300">Prix pour une inscription d'une équipe</h3>
              <p class="mt-6 text-base leading-7 text-gray-100">Lorem ipsum dolor sit amet consect etur adipisicing elit. Itaque amet indis perferendis blanditiis repellendus etur quidem assumenda.</p>
              <div class="mt-10 flex items-center gap-x-4">
                <h4 class="flex-none text-sm font-semibold leading-6 color-light-blue">Ce qui est inclus</h4>
              ...
              <ul role="list" class="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-100 sm:grid-cols-2 sm:gap-6">
                ...
                <li class="flex gap-x-3">
                  ...
                  Un rafraissement apres le match
                </li>
            ...
            <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
              <div class="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                <div class="mx-auto max-w-xs px-8">
                  <p class="text-base font-semibold text-gray-600">Prix par session</p>
                  ...
                  <a href="#" class="mt-10 block w-full rounded-md bg-light-blue px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Je m'inscris</a>
                  <p class="mt-6 text-xs leading-5 text-gray-600">Factures et reçus disponibles pour faciliter le remboursement de l'entreprise</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">Sit quis amet rutrum tellus ullamcorper ultricies libero dolor eget.</p>
          </div>
          <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-2 gap-y-16 gap-x-8 text-center sm:grid-cols-3 md:grid-cols-4 lg:mx-0 lg:max-w-none lg:grid-cols-5 xl:grid-cols-6">
            <li>
              <img class="mx-auto w-50 " src="{{url('/').'/images/sponsors/immovlan.png'}}" alt="">
            </li>
            <li>
              <img class="mx-auto w-50 " src="{{url('/').'/images/sponsors/immovlan.png'}}" alt="">
            </li>
