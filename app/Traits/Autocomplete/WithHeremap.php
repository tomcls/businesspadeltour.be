        ...
        foreach ($suggestions as  $value) {
            ...
            switch ($value->matchLevel) {
                case 'houseNumber':
                    ...
                    $subtitle = $value->address->city . ' ' . ' ' . $value->address->country ;
                    break;
                case 'street':
                ...
                case 'district':
                    ...
                    $subtitle = ($value->address->county ? $value->address->county . ' ' : '') . $value->address->country ;
                    break;
                case 'city':
                    $title = $value->address->city . ($value->address->postalCode ? ', ' . $value->address->postalCode : '');
                    $subtitle = ($value->address->county ? $value->address->county . ' ' : '') . $value->address->country ;
                ...
                case 'county':
                    ...
                    $subtitle = ($value->address->state ? $value->address->state . ' ' : '') . $value->address->country ;
                    break;
                case 'state':
                    $title = $value->address->state;
                    $subtitle = $value->address->country ;
                    break;
                case 'country':
            ...
            $value->label = htmlspecialchars($value->label,ENT_QUOTES);
